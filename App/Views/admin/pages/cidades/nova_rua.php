...
use App\Utils\Session;
 ...
 $this->layout("adm-template::template",[
    "top"         => "Cidades",
    "description" => $cidade['nome']." - Adicionar Rua",
    "title"      => "Adicionar Rua"
]); ?>
<div class="row ">
    <form action="<?=URL?>/adm/cidades/<?=$cidade['id_cidade']?>/nova-rua" method="post">
        <input type="hidden" name="id_cidade" value="<?=$cidade['id_cidade']?>">
        <div class="row">

            <div class="col s12 m4 push-m1 input-field">
                <input type="text" name="nome" id="" required>
                <label for="nome" id="p">NOME</label>
            </div>
        </div>
        ...
        <div class="row center">
            ...
            <div class="col s12 input-field ">
                ...
                <a href="<?=URL?>/adm/cidades/<?=$cidade['id_cidade']?>/" id="cancel" class="btn red">VOLTAR</a>
            </div>
