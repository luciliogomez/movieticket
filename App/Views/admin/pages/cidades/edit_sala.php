...
<div class="row ">
    <form action="<?=URL?>/adm/salas/update" method="post">
        <input type="hidden" name="id_sala" value="<?=$sala['ID_SALA']?>">
        <div class="row">

            <div class="col s12 m4 push-m1 input-field">
                <input type="text" name="numero" id="" value="<?=$sala['NUMERO']?>" required>
                <label for="titulo" id="p">NUMERO</label>
            </div>
            <div class="col s12 m3  push-m2 input-field">
                <input type="number" name="capacidade" id="capacidade" value ="<?=$sala['CAPACIDADE']?>" required min='10'>
        ...
        <div class="row center">
            ...
            <div class="col s12 input-field ">
                <input type="submit" name="add" id="" value="GUARDAR" class="btn blue">
